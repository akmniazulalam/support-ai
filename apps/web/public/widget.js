...
@media (max-width: 480px) {
  ...
  `.trim()}var p=class{constructor(e,t){this.isOpen=!1,this.currentStatus=`initializing`,this.handleWindowKeyDown=e=>{e.key===`Escape`&&this.isOpen&&(this.callbacks.onToggle(),this.launcherBtn.focus())},this.shadow=e,this.callbacks=t,this.buildDOM(),this.attachEventListeners()}buildDOM(){this.launcherBtn=document.createElement(`button`),this.launcherBtn.className=`supportai-launcher`,this.launcherBtn.type=`button`,this.launcherBtn.setAttribute(`aria-label`,`Open support chat`),this.launcherBtn.setAttribute(`aria-expanded`,`false`),this.launcherBtn.setAttribute(`aria-haspopup`,`dialog`),this.launcherBtn.innerHTML=`
